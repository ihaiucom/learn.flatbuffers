...
public struct Monster : IFlatbufferObject
{
  ...
  public bool MutateEquippedType(Equipment equipped_type) { int o = __p.__offset(20); if (o != 0) { __p.bb.Put(o + __p.bb_pos, (byte)equipped_type); return true; } else { return false; } }
